...
namespace WorldShaper
{
    ...
    public class AreaHandle : ScriptableObject
    {
        ...
        public void CreateConnection()
        {
            ...
            string connectionName = EditorUtility.SaveFilePanelInProject("Save Connection Data", "New Connection Data", "asset", "Save Connection Data", ObjectPath());
            if (connectionName != "")
            {
        ...
        private static string ObjectPath()
        {
            ...
            // Find the path of the folder you are currently in
